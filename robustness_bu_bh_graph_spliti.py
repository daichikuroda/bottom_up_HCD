...
for ibeta, beta in enumerate(betas):
    ...
    for iseed in range(num_samples):
        ...
        supercoms, _pm = utild.return_supercoms(Z, bottom_communities)
        ...
        #     true_tree_D,
        #     utild.lca_to_distance_matrix(mea.depth_lcas(com_bits, return_dict=False)),
        #     [bottom_communities[_i] for _i in ordered_estimated],
